...
public class CoordinateTest {
	...
	public void testEqualsSpheric() {
		...
		coordinate = new SphericCoordinate(2, -3, 6);
		assertTrue(coordinate.equals(new SphericCoordinate(2, -3, 6)));
		assertTrue(!coordinate.equals(new SphericCoordinate(2, 2, 7)));
		assertTrue(!coordinate.equals(new SphericCoordinate(3, -1, 4)));
	...
	public void testIsEqual() {
		...
		assertTrue(coordinate.isEqual(new SphericCoordinate(1, 2, 6)));
		assertTrue(!coordinate.isEqual(new SphericCoordinate(1, 3, 7)));
		assertTrue(!coordinate.isEqual(new SphericCoordinate(1, 1, 4)));

		coordinate = new SphericCoordinate(0, 3, 5);
		assertTrue(coordinate.isEqual(new SphericCoordinate(0, 3, 5)));
		assertTrue(!coordinate.isEqual(new SphericCoordinate(3, 0, 5)));
		assertTrue(!coordinate.isEqual(new SphericCoordinate(3, 3, 5)));

		coordinate = new SphericCoordinate(1.5979, -1.0045, 9.1034);
		assertTrue(coordinate.isEqual(new SphericCoordinate(1.5979, -1.0045, 9.1034)));
		assertTrue(!coordinate.isEqual(new SphericCoordinate(2.0, -1.0045, 9.1034)));
		assertTrue(!coordinate.isEqual(new SphericCoordinate(1.5979, 1.2, 9.1034)));
