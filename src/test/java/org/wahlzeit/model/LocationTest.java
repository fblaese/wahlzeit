...
public class LocationTest {
	...
	public void testEquals() {
		...
		location1 = new Location(new Coordinate(1,1), "Test Location");
		location2 = new Location(new Coordinate(1,1), "Test Location");
		assertTrue(location1.equals(location2) == true);

		location2 = new Location(new Coordinate(1,2), "Test Location");
		assertTrue(location1.equals(location2) == false);

		location2 = new Location(new Coordinate(1,1), "Test");
		assertTrue(location1.equals(location2) == false);

		location2 = new Location(new Coordinate(1,2), "Test");
		assertTrue(location1.equals(location2) == false);

		location1 = new Location(new Coordinate(2,2), "");
		location2 = new Location(new Coordinate(2,2), "");
		assertTrue(location1.equals(location2) == true);
